    ...
    <div className="hero">
      ...
      <div className="hero__socials">
        <div className="hero__socials-line">
          ...
          <a href="https://github.com/hankparkyoung">/hankparkyoung</a>
        </div>
        <div className="hero__socials-line">
          <img className="hero__socials-icon" src={linkedinIcon} alt="linkedin icon"/>
          <a href="https://linkedin.com/in/hankparkyoung">/hankparkyoung</a>
        </div>
        <div className="hero__socials-line">
          <img className="hero__socials-icon" src={emailIcon} alt="email icon"/>
          <a href="mailto:hankparkyoung@gmail.com">hankparkyoung@gmail.com</a>
        </div>
      </div>
      <img
